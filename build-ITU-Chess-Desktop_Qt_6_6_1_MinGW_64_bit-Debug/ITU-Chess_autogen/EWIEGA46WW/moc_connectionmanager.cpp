...
#include "../../../ITU-Chess/connectionmanager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSConnectionManagerENDCLASS_t qt_meta_stringdata_CLASSConnectionManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(18, 20),  // "handlePieceSelection"
        QT_MOC_LITERAL(39, 0),  // ""
        QT_MOC_LITERAL(40, 15)   // "gridCoordinates"
    },
    "ConnectionManager",
    "handlePieceSelection",
    "",
...
void ConnectionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->handlePieceSelection((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        default: ;
        }
    }
}
